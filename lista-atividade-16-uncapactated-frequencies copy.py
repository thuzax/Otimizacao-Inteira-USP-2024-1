...
if __name__=="__main__":
    ...
    for i in range(stations):
        for j in range(stations):
            if (minimum_freq_differences[i][j] > 0 and i != j):
                constrs_differnce_i_j.append(
                    model.add_constr(
    ...
    for i in range(stations):
        for j in range(stations):
            if (i != j):
                verify_i_bigger_j.append(
                    model.add_constr(
                        name="i_bigger_j_" + str(i) + "_" + str(j),
                        lin_expr=(
                            frequence_i_bigger_j[i][j]
                            >= 
                            (
    ...
    sum_frequence_i_bigger_j = []
    for i in range(stations):
        for j in range(stations):
            if (i != j):
                verify_i_bigger_j.append(
                    model.add_constr(
                        name="sum_frequence_i_bigger_j_" + str(i) + "_" + str(j),
                        lin_expr=(
                            (
                                frequence_i_bigger_j[i][j] 
                                + 
                                frequence_i_bigger_j[j][i]
                            )
                            ==
                            1
                        )
